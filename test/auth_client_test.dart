...
void main() {
  group('AuthClient.exchange', () {
    test('POSTs identityToken + rawNonce to /auth/apple and parses the session',
        () async {
      ...
      final client =
          AuthClient(baseUrl: 'https://api.example.com/', httpClient: mock);
    ...
    test('maps a non-200 to a friendly AuthException with the server message',
        () async {
      ...
      await expectLater(
        ...
        throwsA(isA<AuthException>()
            ...
            .having((e) => e.message, 'message', contains('verify your Apple'))),
      );
    });
