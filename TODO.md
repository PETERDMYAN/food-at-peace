...
- ✅ **1.0.2 (build 62) — APPROVED & live on the App Store (2026-06-23), tagged `v1.0.2` (`54166a7`)** — the whole Circle/social wave is no longer
  ...
  created + submitted → in review → **approved 2026-06-23 (Ready for Distribution)**. The new `reviewSubmissions` model is what
  this app uses (not the deprecated `appStoreVersionSubmissions`). Metadata/"What's New" already described
  the Circle features. **Shipped** — public release is live; tagged `v1.0.2`.
